...
class TestGetCitations(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if not cls.has_api_key:
            ...
            print("Some tests will be skipped. To run full test suite, add API key to .secrets file.")
    ...
    @unittest.skipUnless(os.getenv("SCRAPERAPI_KEY"), "Requires SCRAPERAPI_KEY environment variable")
    ...
    def test_get_citations_zero_citations(self):
        ...
        expected_columns = ['title', 'author', 'venue', 'year', 'url', 'cited_by', 'bib']
    ...
    def test_error_handling_patterns(self):
        ...
        # None dataset (should handle gracefully)
