...
class ThemeNetworkGenerator:
    ...
    def generate_cluster_word_clouds(
        ...
        # Enhanced stopwords including neuroscience-specific common terms
        default_stopwords = {
            ...
            "might",
            "may",
            # Common verbs and past tense forms
            "was",
            "were",
            "been",
            "being",
            ...
            "my",
            "mine",
            # Generic research terms (too common to be meaningful)
            "study",
            "data",
            "using",
            "used",
            ...
            "page",
            "pages",
            # BIDS and neuroimaging infrastructure terms (too generic)
            "bids",
            "nemar",
            "openneuro",
            "dataset",
            ...
            "interface",
            "api",
            # Generic neuroscience terms (too broad to be distinctive)
            "neural",
            "brain",
            "cognitive",
            "neuroscience",
            ...
            "power",
            "spectrum",
            # Common statistical and analytical terms
            "statistical",
            "statistics",
            "significant",
            "significance",
            ...
            "secondary",
            "additional",
            # Publication and citation terms
            "paper",
            "papers",
            "article",
            "articles",
            ...
            "systematic",
            "literature",
            # Numbers and quantities (spelled out)
            "one",
            "two",
            "three",
            "four",
